    ...
    <section class="section section--ink">
        <div class="container comparison-layout">
            <div class="comparison-copy" data-reveal>
                ...
                <h2>Une installation nette.<br>Une lecture immédiate.</h2>
                <p>Le même local, le même cadrage : faites glisser le curseur pour observer la remise au propre des réseaux et de l’équipement.</p>
                ...
                <p class="media-note">Visuel d’illustration généré par IA. Il ne constitue pas une photographie de chantier RG Plomberie.</p>
            </div>
            <div class="comparison-frame" data-reveal>
                <div class="compare" data-compare style="--position: 50%;">
                    <img class="compare__base" src="{{ asset('assets/img/rg/web/transformations/heating-before.webp') }}" width="1586" height="992" alt="Local technique avec une installation de chauffage vieillissante avant rénovation" loading="eager">
                    <div class="compare__after" data-compare-after>
                        <img src="{{ asset('assets/img/rg/web/transformations/heating-after.webp') }}" width="1586" height="992" alt="Projection du même local après rénovation de l’installation de chauffage" loading="eager">
                    </div>
                    ...
                    <input class="compare__range" data-compare-range type="range" min="0" max="100" value="50" aria-label="Comparer l’installation de chauffage avant et après rénovation">
                </div>
            </div>
        </div>
    </section>
